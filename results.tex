...
\Cref{z_mesh_sol} with the one obtained using an uniform \Cref{u_mesh_sol}. 
The domain is 1cm by 1cm and is discretized using 20 by 20 cells. All the 
boundary conditions are vacuum. The medium is homogeneous $\Sigma = 0.5 cm^{-1}$ 
...
\begin{figure}[H]
  \centering
  %\includegraphics[width=5cm]{u_mesh_sol}
