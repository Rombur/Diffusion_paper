...
grids using a {\em discontinuous} finite element discretization. 

The motivations for this are three-fold: 
\begin{enumerate}
\item to assess the performance of {\em discontinuous} finite element discretization
\item DFEM SN transport
\item 
\end{enumerate}
