...
\begin{itemize}
  ...
  \item The notion of ``hanging nodes'' for locally refined /adapted meshed is no longer needed.
	For example, \figf{fig:amr1} shows two quadrilateral elements before local refinement; on
	\figf{fig:amr2}, one of the two cells has been refined. The un-refined cell is now viewed as a
	pentagon.
\end{itemize}
...
\label{fig:pentagons}
\caption{Non-degenerate pentagon and degenerate pentagonal cells}
\end{figure}
